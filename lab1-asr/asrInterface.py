...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button.setGeometry(QtCore.QRect(170, 450, 50, 50))
        self.button.setStyleSheet("QPushButton{border-image: url(img/1.png)}"
                                  "QPushButton:hover{border-image: url(img/1.1.png)}"
                                  "QPushButton:pressed{border-image: url(img/1.1.png)}")

        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(60, 280, 314, 51))
        font = QtGui.QFont()
        ...
        self.voiceFig.setGeometry(QtCore.QRect(110, 50, 161, 121))
        ...
        self.label.setGeometry(QtCore.QRect(100, 160, 314, 21))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        ...
        self.label_4.setGeometry(QtCore.QRect(60, 330, 314, 51))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
